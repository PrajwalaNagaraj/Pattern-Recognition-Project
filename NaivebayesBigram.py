...
import nltk.metrics
from nltk import SklearnClassifier, DecisionTreeClassifier
...
def naiveBaseClassifier(featx):
    ...
    posdata=pd.read_csv(r'posReview.csv', sep=',')
    negdata=pd.read_csv(r'negReview.csv', sep=',')
    ...
    print('accuracy:', nltk.classify.util.accuracy(classifier, testdata)*100)
