...
#import XML data from .Xml files and parse them to two csv[posReview.csv, negReview.csv]
tree = ET.parse(r"C:\Users\Nagaraj\Desktop\neg.xml")
tree1 = ET.parse(r"C:\Users\Nagaraj\Desktop\positivecopy.xml")
root = tree.getroot()
root1 = tree1.getroot()
...
#making .csv files 
negdata.to_csv(r'C:\Users\Nagaraj\Desktop\negReview.csv', sep=',')
posdata.to_csv(r'C:\Users\Nagaraj\Desktop\posReview.csv', sep=',')
